...
const Navbar = () => {
  ...
  const { getTotalCartAmount, token, setToken, setShowLogin } =
    ...
    <div className="navbar">
      <div className="navbar_top">
        <div className="navbar_top__left">
          <Link to="/">
            <img src={assets2.logo_epl} alt="Логотип" className="logo" />
          </Link>
        </div>
          ...
          <div className="navbar-top__login">
            {!token ? (
              <div className="login_block">
                ...
                <img className="login-icon" src={assets.login_icon} alt="" />{" "}
              </div>
            ) : (
