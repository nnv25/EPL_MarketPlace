        ...
        <div className="login-popup-condition">
          {currState === "Зарегистрироваться" ? (
            <div>
              ...
              <p>
                Нажимая на "Зарегистрироваться" я принимаю <span>Пользовательское соглашение и Политику
                конфиденциальности</span>, а также даю согласие на обработку моих персональных данных
              </p>
            </div>
          ) : null}
          {currState !== "Зарегистрироваться" ? (
